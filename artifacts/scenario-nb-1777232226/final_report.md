...
- Bootstrap samples: `0`
- Avg scoring latency ms: `11.036`
- BMU coverage count: `26`
- Scored by phase: `{'chaos': 0, 'cooldown': 55, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1777232226/som_snapshot.json`
