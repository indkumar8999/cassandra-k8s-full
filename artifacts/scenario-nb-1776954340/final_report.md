...
- Bootstrap samples: `0`
- Avg scoring latency ms: `7.708`
- BMU coverage count: `45`
- Scored by phase: `{'chaos': 108, 'cooldown': 53, 'load': 0, 'normal': 26}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `108`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776954340/som_snapshot.json`
