...
## SOM Runtime Metrics
- Training duration sec: `1.309`
- Bootstrap samples: `350`
- Avg scoring latency ms: `15.072`
- BMU coverage count: `90`
- Scored by phase: `{'chaos': 21, 'cooldown': 107, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776936620/som_snapshot.json`
