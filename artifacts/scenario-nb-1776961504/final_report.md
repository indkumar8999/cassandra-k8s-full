...
- Bootstrap samples: `0`
- Avg scoring latency ms: `17.658`
- BMU coverage count: `31`
- Scored by phase: `{'chaos': 0, 'cooldown': 54, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776961504/som_snapshot.json`
