...
- Bootstrap samples: `0`
- Avg scoring latency ms: `17.631`
- BMU coverage count: `31`
- Scored by phase: `{'chaos': 1, 'cooldown': 53, 'load': 0, 'normal': 27}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `False`
- Chaos scored samples: `1`
- Chaos min required: `50`
- Message: `chaos scored samples too low: 1 < 50`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776942205/som_snapshot.json`
