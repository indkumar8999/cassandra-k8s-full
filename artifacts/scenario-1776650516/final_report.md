...
- Commanded chaos window: `{'start_ts': 1776650878.607438, 'stop_ts': 1776650998.61896}`
...
## SOM Runtime Metrics
- Training duration sec: `0.459`
- Bootstrap samples: `350`
- Avg scoring latency ms: `2.832`
- BMU coverage count: `297`
- Scored by phase: `{'chaos': 333, 'cooldown': 340, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `333`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-1776650516/som_snapshot.json`
