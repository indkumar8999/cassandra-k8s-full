...
- Commanded chaos window: `{'start_ts': 1776896163.586293, 'stop_ts': 1776896283.64302}`
...
## SOM Runtime Metrics
- Training duration sec: `0.329`
- Bootstrap samples: `350`
- Avg scoring latency ms: `3.069`
- BMU coverage count: `113`
- Scored by phase: `{'chaos': 185, 'cooldown': 203, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `185`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776895983/som_snapshot.json`
