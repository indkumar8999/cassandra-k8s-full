...
## Run Metadata
- Run ID: `stress-ramp-s3-compaction-v2`
...
- Commanded chaos window: `{'start_ts': 1776462419.097018, 'stop_ts': 1776462659.113871}`
...
- Bootstrap samples: `536`
- Avg scoring latency ms: `0.174`
- BMU coverage count: `9`
- Scored by phase: `{'chaos': 91, 'cooldown': 0, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `91`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/stress-ramp-s3-compaction-v2/som_snapshot.json`
