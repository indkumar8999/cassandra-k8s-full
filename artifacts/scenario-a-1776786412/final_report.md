...
- Commanded chaos window: `{'start_ts': 1776786594.1805592, 'stop_ts': 1776786714.418696}`
...
## SOM Runtime Metrics
- Training duration sec: `0.304`
- Bootstrap samples: `370`
- Avg scoring latency ms: `3.331`
- BMU coverage count: `125`
- Scored by phase: `{'chaos': 121, 'cooldown': 184, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `121`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776786412/som_snapshot.json`
