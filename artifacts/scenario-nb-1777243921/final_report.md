...
- Bootstrap samples: `0`
- Avg scoring latency ms: `7.864`
- BMU coverage count: `26`
- Scored by phase: `{'chaos': 110, 'cooldown': 54, 'load': 0, 'normal': 27}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `110`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1777243921/som_snapshot.json`
