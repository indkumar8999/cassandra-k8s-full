...
- Commanded chaos window: `{'start_ts': 1776720559.83323, 'stop_ts': 1776720739.906419}`
...
## SOM Runtime Metrics
- Training duration sec: `0.125`
- Bootstrap samples: `350`
- Avg scoring latency ms: `2.75`
- BMU coverage count: `27`
- Scored by phase: `{'chaos': 101, 'cooldown': 49, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `101`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-b-1776720139/som_snapshot.json`
