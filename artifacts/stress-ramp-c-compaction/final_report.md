...
## Run Metadata
- Run ID: `stress-ramp-c-compaction`
...
- Commanded chaos window: `{'start_ts': 1776458556.5157728, 'stop_ts': 1776458736.534061}`
...
## SOM Runtime Metrics
- Training duration sec: `0.021`
- Bootstrap samples: `535`
- Avg scoring latency ms: `0.216`
- BMU coverage count: `14`
- Scored by phase: `{'chaos': 220, 'cooldown': 0, 'load': 0, 'normal': 2}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `220`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/stress-ramp-c-compaction/som_snapshot.json`
