...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.742`
- BMU coverage count: `34`
- Scored by phase: `{'chaos': 55, 'cooldown': 54, 'load': 0, 'normal': 28}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `55`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776953578/som_snapshot.json`
