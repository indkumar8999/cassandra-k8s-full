...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.51`
- BMU coverage count: `25`
- Scored by phase: `{'chaos': 54, 'cooldown': 53, 'load': 0, 'normal': 27}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `54`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776942663/som_snapshot.json`
