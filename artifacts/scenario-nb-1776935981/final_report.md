...
## SOM Runtime Metrics
- Training duration sec: `1.191`
- Bootstrap samples: `350`
- Avg scoring latency ms: `4.52`
- BMU coverage count: `145`
- Scored by phase: `{'chaos': 443, 'cooldown': 106, 'load': 0, 'normal': 28}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `443`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776935981/som_snapshot.json`
