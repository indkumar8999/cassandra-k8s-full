...
- Commanded chaos window: `{'start_ts': 1776728535.5917199, 'stop_ts': 1776728655.679643}`
...
## SOM Runtime Metrics
- Training duration sec: `0.076`
- Bootstrap samples: `350`
- Avg scoring latency ms: `4.668`
- BMU coverage count: `47`
- Scored by phase: `{'chaos': 19, 'cooldown': 161, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `False`
- Chaos scored samples: `19`
- Chaos min required: `50`
- Message: `chaos scored samples too low: 19 < 50`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776728355/som_snapshot.json`
