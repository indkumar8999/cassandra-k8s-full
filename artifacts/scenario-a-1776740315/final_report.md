...
- Commanded chaos window: `{'start_ts': 1776740496.103895, 'stop_ts': 1776740616.2475772}`
...
## Lead-Time / Delay
- First detection delay sec: `33.6547749042511`
- Mean detection delay sec: `45.842069786787036`
- Median detection delay sec: `44.799203515052795`

## SOM Runtime Metrics
- Training duration sec: `0.321`
- Bootstrap samples: `350`
- Avg scoring latency ms: `3.196`
- BMU coverage count: `137`
- Scored by phase: `{'chaos': 162, 'cooldown': 190, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `162`
...
## Top Cause Metrics
- `tier_a_memory_working_set_bytes`: `40`
- `tier_a_cpu_usage_cores`: `3`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776740315/som_snapshot.json`
