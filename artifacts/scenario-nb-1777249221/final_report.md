...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.779`
- BMU coverage count: `37`
- Scored by phase: `{'chaos': 55, 'cooldown': 53, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1777249221/som_snapshot.json`
