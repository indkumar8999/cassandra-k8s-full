...
- Commanded chaos window: `{'start_ts': 1776572783.153625, 'stop_ts': 1776572903.219788}`
...
## SOM Runtime Metrics
- Training duration sec: `0.452`
- Bootstrap samples: `350`
- Avg scoring latency ms: `2.138`
- BMU coverage count: `67`
- Scored by phase: `{'chaos': 253, 'cooldown': 129, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `253`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-1776572420/som_snapshot.json`
