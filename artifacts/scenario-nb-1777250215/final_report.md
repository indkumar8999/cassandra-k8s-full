...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.498`
- BMU coverage count: `28`
- Scored by phase: `{'chaos': 55, 'cooldown': 54, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1777250215/som_snapshot.json`
