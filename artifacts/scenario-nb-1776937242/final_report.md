...
## SOM Runtime Metrics
- Training duration sec: `1.234`
- Bootstrap samples: `350`
- Avg scoring latency ms: `9.734`
- BMU coverage count: `148`
- Scored by phase: `{'chaos': 112, 'cooldown': 107, 'load': 0, 'normal': 26}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `112`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776937242/som_snapshot.json`
