...
- Bootstrap samples: `0`
- Avg scoring latency ms: `13.942`
- BMU coverage count: `38`
- Scored by phase: `{'chaos': 21, 'cooldown': 53, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776954603/som_snapshot.json`
