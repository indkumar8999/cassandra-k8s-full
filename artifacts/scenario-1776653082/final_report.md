...
- Commanded chaos window: `{'start_ts': 1776653444.914973, 'stop_ts': 1776653564.9287329}`
...
## SOM Runtime Metrics
- Training duration sec: `0.31`
- Bootstrap samples: `350`
- Avg scoring latency ms: `2.829`
- BMU coverage count: `229`
- Scored by phase: `{'chaos': 338, 'cooldown': 339, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `338`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-1776653082/som_snapshot.json`
