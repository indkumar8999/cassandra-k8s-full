...
- Commanded chaos window: `{'start_ts': 1776736967.112397, 'stop_ts': 1776737087.218782}`
...
## SOM Runtime Metrics
- Training duration sec: `0.295`
- Bootstrap samples: `350`
- Avg scoring latency ms: `2.908`
- BMU coverage count: `132`
- Scored by phase: `{'chaos': 189, 'cooldown': 201, 'load': 0, 'normal': 0}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `189`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776736786/som_snapshot.json`
