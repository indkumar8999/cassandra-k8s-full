...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.333`
- BMU coverage count: `42`
- Scored by phase: `{'chaos': 56, 'cooldown': 53, 'load': 0, 'normal': 27}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `True`
- Chaos scored samples: `56`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776962125/som_snapshot.json`
