...
- Bootstrap samples: `0`
- Avg scoring latency ms: `10.528`
- BMU coverage count: `62`
- Scored by phase: `{'chaos': 55, 'cooldown': 52, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776961891/som_snapshot.json`
