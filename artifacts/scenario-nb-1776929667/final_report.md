...
## SOM Runtime Metrics
- Training duration sec: `1.255`
- Bootstrap samples: `350`
- Avg scoring latency ms: `9.577`
- BMU coverage count: `132`
- Scored by phase: `{'chaos': 111, 'cooldown': 107, 'load': 0, 'normal': 27}`
...
- Snapshot JSON: `/home/nirala/cassandra-k8s-full/artifacts/scenario-nb-1776929667/som_snapshot.json`
