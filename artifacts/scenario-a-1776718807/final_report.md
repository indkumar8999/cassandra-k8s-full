...
- Commanded chaos window: `{'start_ts': 1776719259.92124, 'stop_ts': 1776719380.002162}`
...
## SOM Runtime Metrics
- Training duration sec: `0.327`
- Bootstrap samples: `350`
- Avg scoring latency ms: `5.373`
- BMU coverage count: `254`
- Scored by phase: `{'chaos': 34, 'cooldown': 481, 'load': 0, 'normal': 217}`
- Dropped missing Tier A: `0`
- Dropped missing Tier B: `None`

## Run Quality Gate
- Passed: `False`
- Chaos scored samples: `34`
- Chaos min required: `50`
- Message: `chaos scored samples too low: 34 < 50`
...
- Snapshot JSON: `/Users/aumpandya/Documents/Projects/ads_project/cassandra/artifacts/scenario-a-1776718807/som_snapshot.json`
